...
func BindClient(clientResource *slaoperatorv1alpha1.Slaml, IP string) bool {
...
func HasClients(clientResource *slaoperatorv1alpha1.Slaml, IP string) bool {
...
func GetClient(clientResource *slaoperatorv1alpha1.Slaml, IP string) bool {
